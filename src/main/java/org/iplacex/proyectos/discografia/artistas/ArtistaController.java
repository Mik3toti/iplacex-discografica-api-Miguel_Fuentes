...
public class ArtistaController {
    ...
    public ResponseEntity<Artista> HandlerInsertArtistaRequest(@RequestBody Artista art){
        Artista temp = artistaRepo.insert(art);
    ...
    public ResponseEntity<List<Artista>> HandlerGetAristasRequest(){
